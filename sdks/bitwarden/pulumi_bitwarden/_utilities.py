...
async def _await_output(o: pulumi.Output[typing.Any]) -> tuple[object, bool, bool, set]:
    return (
        await o._future,
        await o._is_known,
        await o._is_secret,
			...
			async with _package_lock:
				if _package_ref is ...:
					...
					parameterization = resource_pb2.Parameterization(
						name="bitwarden",
						version=get_version(),
						value=base64.b64decode("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL21heGxhdmVyc2UvYml0d2FyZGVuIiwidmVyc2lvbiI6IjAuMTQuMCJ9fQ=="),
					)
