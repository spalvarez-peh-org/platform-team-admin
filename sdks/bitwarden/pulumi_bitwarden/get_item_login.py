...
class GetItemLoginResult:
    ...
    def filter_url(self) -> _builtins.str | None:
...
def get_item_login(filter_collection_id: _builtins.str | None = None,
                   filter_folder_id: _builtins.str | None = None,
                   filter_organization_id: _builtins.str | None = None,
                   filter_url: _builtins.str | None = None,
                   id: _builtins.str | None = None,
                   search: _builtins.str | None = None,
                   opts: pulumi.InvokeOptions | None = None) -> AwaitableGetItemLoginResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('bitwarden:index/getItemLogin:getItemLogin', __args__, opts=opts, typ=GetItemLoginResult, package_ref=_utilities.get_package()).value
...
def get_item_login_output(filter_collection_id: pulumi.Input[_builtins.str | None] | None = None,
                          ...
                          filter_url: pulumi.Input[_builtins.str | None] | None = None,
                          id: pulumi.Input[_builtins.str | None] | None = None,
                          search: pulumi.Input[_builtins.str | None] | None = None,
                          opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None) -> pulumi.Output[GetItemLoginResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('bitwarden:index/getItemLogin:getItemLogin', __args__, opts=opts, typ=GetItemLoginResult, package_ref=_utilities.get_package())
    return __ret__.apply(lambda __response__: GetItemLoginResult(
        ...
        filter_url=pulumi.get(__response__, 'filter_url'),
        ...
        totp=pulumi.get(__response__, 'totp'),
